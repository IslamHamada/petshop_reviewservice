...
class ReviewControllerTest {
    ...
    public class getReviewById {
        ...
        public void failure_bad_input(Object review_id) throws Exception {
            MvcResult mvcResult = mockMvc.perform(get("/review/" + review_id)
                    .with(jwt().authorities(neededRole))
    ...
    public class getReviewsByProductId {
        ...
        public void success() throws Exception {
            ...
            MvcResult mvcResult = mockMvc.perform(get("/review/product/" + product_id))
                    .andExpect(MockMvcResultMatchers.status().isOk())
                    .andReturn();
        ...
        public void failure_bad_input() throws Exception {
            long product_id = -1;
            mockMvc.perform(get("/review/product" + product_id))
                    .andExpect(MockMvcResultMatchers.status().isBadRequest())
                    .andReturn();
        }
    }
